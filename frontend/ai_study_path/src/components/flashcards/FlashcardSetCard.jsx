...
const FlashcardSetCard = ({flashcardSet}) => {
  ...
  return (
    <div className='group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-100 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-200/10 flex flex-col justify-between' onClick={handleStudyNow}>
      <div className='space-y-4'>
        {/* Icon and Title */}
        <div className='flex items-start gap-4'>
          <div className='shrink-0 w-12 h-12 rounded-xl bg-linear-to-br from-slate-100 to-slate-400 flex items-center justify-center'>
        ...
        {totalCards > 0 && (
          <div className='space-y-2'>
            ...
            <div className='relative h-2 bg-slate-100 rounded-full overflow-hidden'>
              <div
                className='absolute inset-s-0 left-0 bg-linear-to-r from-slate-500 to-slate-800 rounded-full transition-all duration-500'
      ...
      <div className='mt-6 pt-4 border-t border-slate-100'>
        <button
           ...
           className='group/btn relative w-full h-11 bg-linear-to-r from-slate-300 to-slate-500 hover:from-slate-400 hover:to-slate-700 text-slate-800 hover:text-white font-semibold text-sm rounded-xl transition-all duration-200 active:scale-95 overflow-hidden'
        >
