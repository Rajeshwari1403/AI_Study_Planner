      ...
      <div className='bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 p-8 mb-8'>
        <div className='text-center space-y-6'>
          ...
          <div className='flex items-center justify-center gap-4 pt-4'>
            ...
            <div className='flex items-center gap-2 px-4 py-2 bg-red-50 border border-rose-200 rounded-xl'>
            ...
            <div key={index} className='bg-white/80 backdrop-blur-xl border-2 border-slate-400 rounded-2xl p-6 shadow-lg shadow-slate-200/60'>
              <div className='flex items-start justify-between gap-4 mb-3'>
                <div className='flex-1'>
                  <div className='inline-flex items-center gap-3 px-3 py-1 bg-slate-50 border border-slate-200 rounded-lg mb-2'>
                    ...
                    >
                      <div className='flex items-center justify-between gap-3'>
                        ...
                        <div className='flex items-center gap-2'>
                          {isCorrectOption && (
                            <span className='inline items-center gap-1 px-2 py-1 bg-emerald-100 border border-emerald-300 rounded-lg text-xs font-semibold text-emerald-700'>
            ...
            {/*{result.explanation && (
              <div className='p-4 bg-linear-to-br from-slate-50 to-slate-100/50 border border-slate-200 rounded-xl'>
                <div className='flex items-start gap-3'>
                  <div className='shrink-0 w-8 h-8 rounded-lg bg-slate-200 items-center flex justify-center mt-0.5'>
